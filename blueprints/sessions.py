...
def create_interview_session():
    ...
    # Validate level against database enum values
    # Database enum: "Intern", "Fresher", "Junior", "Mid", "Senior", "Lead"
    valid_levels = ["Intern", "Fresher", "Junior", "Mid", "Senior", "Lead"]
    ...
    try:
        ...
        config_data = {
            "session_id": session_id,
            "position": position,
            "level": level,  # Use level directly (already validated)
            "cv_url": cv_url,
